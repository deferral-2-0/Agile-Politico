...
@path_2.route('/users/<int:user_id>/phonenumber', methods=['PATCH'])
@token_required
def update_user_phonenumber(user, user_id):
    ...
    if user[0][1] == user_id:
        try:
            ...
            abort(utils.response_fn(400, "error", "Must provide phone number"))
        ...
        UserModel.update_phone_number(phone_num, user_id)
